...
// - If there are odd numbers of 1's, we set the bit. If there are even number
// of 1's, bit is unset.
//   What does this mean?
//   - This basically says that if noOf1sCount % 2 is 1, we set the bit,
//   otherwise don't.
//
// Taking this a step forward. Now, we start counting if noOf1sCount % 3 is (1
// or 2). In the end remainder two component should be zero, as 3 times occuring
// will become zero. Also the one time occuring, the only one left would remain
// in 1 remainder variable.
//
