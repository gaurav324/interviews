// There is dictionary of words(D) and given two strings s and t. Determine
// whether if s produces t or not. Produces: s0, s1, ... t All strings in
// dictionary are of same length and all s(i)s are only one character apart.
// Return min length of the sequence.
//

// THINGS LEARNT:
// 1) Whenever think of min steps of converting A -> B, string  or something
// else, where I might try to use all combinations, think of BFS.
...
int main() {
  unordered_set<string> dict = {"cat", "mow", "bat", "bet",
                                "lat", "lot", "mot"};
